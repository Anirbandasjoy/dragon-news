            ...
            <div>
                ...
                <div className='mt-7 px-2 space-y-2'>
                    <div className='relative'>
                        <button onClick={handleGoogleLogin} className='border-2 rounded-md text-lime-500 w-full p-3 border-lime-500'>
                            Login with Google
                        </button>
                    ...
                    <div className='relative'>
                        <button onClick={handleGithubLogin} className='border-2 rounded-md text-black w-full p-3 border-black'>
                            Login with Google
                        </button>
